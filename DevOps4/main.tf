...
resource "aws_key_pair" "xops_key" {
  key_name   = "terraform_gopika"
  public_key = file("C:/Users/Gopika_A/Downloads/DevOps4/terraform-gopika.pub")
}
...
resource "aws_instance" "xops_ec2" {
  ...
  subnet_id              = element(data.aws_subnets.default.ids, 1) # pick a different subnet if needed
